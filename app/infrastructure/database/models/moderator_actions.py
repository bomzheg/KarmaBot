...
class ModeratorEvent(Model):
    ...
    def __repr__(self):
        ...
        return (
            f"ModeratorEvent {self.id_} from moderator {self.moderator_id} "
            f"to {self.user_id}, date {self.date}, type_restriction {self.type_restriction} "
            f"timedelta_restriction {self.timedelta_restriction}"
        )
