...
async def cmd_start(message: types.Message):
    ...
    await message.answer(
        ...
        "<code>!help</code> – справка об основных командах\n"
...
async def cmd_moderator_help(message: types.Message):
    ...
    await message.reply(
        ...
        "его через @. "
        "Все команды из данного списка требуют указания пользователя.\n\n"
        "💢Команды модераторов:\n"
...
async def cmd_advanced_help(message: types.Message):
    ...
    await message.reply(
        ...
        "🦾Сила, с которой пользователь меняет другим карму, зависит от собственной кармы, чем она "
        "больше, тем больше будет изменение. "
        "Максимально возможное изменение кармы вычисляется как корень из кармы.\n\n"
        "🤖Основные команды:\n"
        ...
        "💢Команды модераторов:\n"
        "<code>!ro</code> [время] – ограничить пользователю возможность "
        "писать в чате. Пользователь сможет только использовать реакции\n"
        "<code>!ban</code> [время] – заблокировать пользователя\n"
        "<code>!warn</code> – выдать предупреждение пользователю\n"
        "<code>!info</code> – показать информацию о пользователе: изменения кармы, ограничения и "
        "предупреждения\n\n"
