...
from app.infrastructure.database.models import KarmaEvent, ModeratorEvent, Report, User
            ...
            [
                InlineKeyboardButton(
                    ...
                    callback_data=KarmaCancelCb(
                        ...
                        if moderator_event is not None
                        else "null",
                    ).pack(),
                )
            ]
            ...
            [
                InlineKeyboardButton(
                    ...
                    callback_data=WarnCancelCb(
                        user_id=user.tg_id, moderator_event_id=moderator_event.id_
                    ).pack(),
                )
            ]
        ]
...
def get_report_reaction_kb(user: User, report: Report) -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[[approve, decline], [cancel]])
